...
public class PosEnhancedSplineFollower extends PosBasicSplineFollower implements Follower {
    ...
    public PosEnhancedSplineFollower(Spline spline, double splineR, double splineRes, double maxToVel, double toVelSearchRadius,
                                      Waypoints waypoints) {
        super(spline, splineR, splineRes, 0 , maxToVel, waypoints);
        waypoints.addWaypoint(new Waypoint(spline.pieces-.01, () -> {
        }, 0));
...
//        System.out.println(pos);
    ...
    public static void main(String[] args) {
        ...
        PosEnhancedSplineFollower posBasicSplineFollower = new PosEnhancedSplineFollower(spline, .1, .01,
                 .5, .01, w);
