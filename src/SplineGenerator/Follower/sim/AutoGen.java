...
public class AutoGen {
    ...
    static {
        ...
        waypointMapAboutZero.put("PH", new AutoGenWaypoint[]{new AutoGenWaypoint("PlaceHighCont", -.7, transitSpeed), new AutoGenWaypoint("none", -.3, transitSpeed / 3.0), new AutoGenWaypoint("dropWithWait",0, transitSpeed * .8 / 3.0)});
     ...
     */
    public void createAuto(String autoData) {
        ...
        for (AutoGenAngle angle : angles) {
            ...
            angleData.put("speed", angle.getSpeed());
